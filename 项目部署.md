...
在`/etc/nginx/conf.d`目录下，新建一个文件，叫做`qfbbs.conf`，然后将以下代码粘贴进去：

```conf
upstream qfbbs{
    server unix:///srv/qfbbs/qfbbs.sock; 
}
