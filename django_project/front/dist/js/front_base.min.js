...
$(function () {
    if(window.template){
        template.defaults.imports.TimeKangbazi =  function (dataValue) {
            var date = new Date(dataValue);
            var datets = date.getTime();//毫秒级别的
            var nowts = (new Date()).getTime();
            var timestamp = (nowts-datets)/1000;//秒
             if(timestamp < 60){
                 return '刚刚';
